#!/bin/bash
# Script per sostituire l'ultima riga di build.prop con un blocco di configurazioni personalizzate

FILE="system_modified/system/build.prop"

# Definisce il nuovo blocco da inserire
...
dalvik.vm.heaptargetutilization=0.60
...
window.animation_scale=0.5
transition.animation_scale=0.5
animator.duration_scale=0.5
...
echo "✅ Modifica completata con successo!"
