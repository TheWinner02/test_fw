...
rm -rf s23fe/ROM/system/system/etc/bpf/cloBpf.o
rm -rf s23fe/ROM/system/system/etc/bpf/netlog.o
rm -rf s23fe/ROM/system/system/etc/bpf/tcpAccECN.o
rm -rf s23fe/ROM/system/system/etc/bpf/tosMarker.o
...
rm -rf s23fe/ROM/system/system/etc/objectremoval
rm -rf s23fe/ROM/system/system/etc/reflectionremoval
rm -rf s23fe/ROM/system/system/etc/shadowremoval
...
rm -rf s23fe/ROM/product/app/*/oat
rm -rf s23fe/ROM/product/priv-app/*/oat
rm -rf s23fe/ROM/system/system/app/*/oat
rm -rf s23fe/ROM/system/system/priv-app/*/oat
rm -rf s23fe/ROM/system/system/system_ext/app/*/oat
rm -rf s23fe/ROM/system/system/system_ext/priv-app/*/oat
